...
**Replaces:** Danse Macabre

Your shadow splits, reaching out and reanimating up to five Tiny, Small or Medium corpses of challenge rating 1/4 or higher that you can see within range. Each corpse immediately transforms into an undead creature of the same size, which takes your choice of form ([Skeleton](/📚%20-%20Information%20Compendium/bestiary/undead/skeleton-corpse-puppet-spellsthatdontsuck.md) or [Zombie](/📚%20-%20Information%20Compendium/bestiary/undead/zombie-corpse-puppet-spellsthatdontsuck.md)) using the Corpse Puppet stat block.
...
*Source: Spells That Don't Suck p. 13*