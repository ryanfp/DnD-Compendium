...
A Medium creature that hunkers behind the wall has <span title="Player's Handbook (2024)">Half Cover</span>, and a Small creature that hunkers behind it has <span title="Player's Handbook (2024)">Three-Quarters Cover</span>. The wall can be leapt over without spending any additional movement.
