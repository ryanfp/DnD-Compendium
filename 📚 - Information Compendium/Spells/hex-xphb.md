...
You place a curse on a creature that you can see within range. Until the spell ends, you deal an extra `d6` Necrotic damage to the target whenever you hit it with an attack roll. Also, choose one ability when you cast the spell. The target has [Disadvantage](/📚%20-%20Information%20Compendium/📝%20-%20Rules%20&%20Mechanics/variant-rules/disadvantage-xphb.md) on ability checks made with the chosen ability.
