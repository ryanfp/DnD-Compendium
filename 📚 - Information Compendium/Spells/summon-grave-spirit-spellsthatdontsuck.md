...
- **Range:** 60 feet
- **Components:** V, S, M (a jeweled skull statuette worth at least 300 gp)
- **Duration:** Concentration, up to 1 hour

**Replaces:** Summon Undead

You summon an undead creature which manifests in an unoccupied space that you can see within range. It uses the [Grave Spirit](/📚%20-%20Information%20Compendium/bestiary/undead/grave-spirit-spellsthatdontsuck.md) stat block, and you select the Ethereal, Ghoulish, or Bone option when you cast the spell. The creature disappears when it drops to 0 hit points or when the spell ends.
