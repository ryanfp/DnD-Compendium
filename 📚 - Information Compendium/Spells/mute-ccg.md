...
You touch a creature or object of medium size or smaller, [muting](conditions.md#Muted) the target for the duration. If the target is a creature and is unwilling, it can make a Constitution saving throw to avoid this effect. A muted target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.
