...
You recite a deadly cursing dirge, predicting impending doom for a creature you can see within range. You place this curse upon the chosen creature, and until the spell ends, your attacks deal an extra `d8` psychic damage against it. Also, whenever the target misses you with an attack roll during its turn, it takes `d8` psychic damage, and must make a Wisdom saving throw. On a failure, it is frightened of you until the start of its next turn.
