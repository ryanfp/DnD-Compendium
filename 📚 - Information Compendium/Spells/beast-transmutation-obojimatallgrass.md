...
This spell transforms a beast that you can see within range into a new humanoid form. An unwilling creature must succeed on a Wisdom saving throw to avoid the effect. The spell has no effect on a beast with 0 hit points.

The transformation lasts for the duration, or until the target drops to 0 hit points or dies. The new form has the appearance of a humanoid of any race you choose. The target's game statistics, excluding mental ability scores, are replaced by the statistics of a commoner. It retains its alignment and personality.
...
*Source: Obojima: Tales from the Tall Grass p. 182*