...
You channel lightning into your hands. The next time you hit a creature with a melee attack (including a melee spell attack) before the start of your next turn, the target takes `d12` lightning damage and must make a Constitution saving throw. On a failed save, the target becomes shocked, stunning them until the start of their next turn.
