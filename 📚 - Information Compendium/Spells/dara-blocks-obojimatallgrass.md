...
- **Range:** 60 feet
- **Components:** V, S, M (a pinch of sand and a piece of pottery)
- **Duration:** 1 minute
...
A block fixed in the air can hold up to 5,000 pounds of weight. More weight causes the block to fall. A creature can use an action to make a Strength check against your spell save DC, moving the fixed block up to 10 feet on a success.
...
*Source: Obojima: Tales from the Tall Grass p. 184*