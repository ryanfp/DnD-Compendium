...
**Replaces:** Prismatic Spray

You send a shimmering wave of force outward, striking each creature within a 60-foot cone with a random blast of magic. Roll `d8` on the table below for each target struck by the blast. That creature must make a Dexterity saving throw, suffering the effects below on a failure or half the initial damage and no additional effects on a success.

`dice: [](scintillant-blast-spellsthatdontsuck.md#^1-damage-type-effect)`
...
| 8 | Multiple | The target is struck by multiple blasts. Roll twice more, rerolling any 8's. |
^1-damage-type-effect

*Source: Spells That Don't Suck p. 38*