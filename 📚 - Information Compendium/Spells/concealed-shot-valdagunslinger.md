...
- spell/subclass/secret-agent
classes:
- Gunslinger (Secret Agent)
aliases:
- Concealed Shot
---
# Concealed Shot
...
**Classes**: [Gunslinger (Secret Agent)](/📚%20-%20Information%20Compendium/lists/list-spells-classes-secret-agent-valdagunslinger.md "subclass=ValdaGunslinger;class=ValdaGunslinger")
