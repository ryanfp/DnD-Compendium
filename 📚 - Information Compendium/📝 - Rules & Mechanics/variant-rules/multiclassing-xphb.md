...
If you have multiple ways to calculate your [Armor Class](/📚%20-%20Information%20Compendium/📝%20-%20Rules%20&%20Mechanics/variant-rules/armor-class-xphb.md), you can benefit from only one at a time. For example, a Monk/Sorcerer with a Monk's Unarmored Defense feature and a Sorcerer's Draconic Resilience feature must choose only one of those features as a way to calculate Armor Class.
...
![Spellcasting; Multiclass Spellcaster: Spell Slots per Spell Level](/📚%20-%20Information%20Compendium/tables/spellcasting-multiclass-spellcaster-spell-slots-per-spell-level-xphb.md)
...
This table might give you spell slots of a higher level than the spells you prepare. You can use those slots but only to cast your lower-level spells. If a lower-level spell that you cast, like [Burning Hands](/📚%20-%20Information%20Compendium/spells/burning-hands-xphb.md), has an enhanced effect when cast at a higher level, you can use the enhanced effect as normal.
