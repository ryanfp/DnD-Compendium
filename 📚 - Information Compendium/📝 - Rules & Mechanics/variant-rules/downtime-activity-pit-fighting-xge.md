...
The character makes three checks: Strength ([Athletics](/📚%20-%20Information%20Compendium/📝%20-%20Rules%20&%20Mechanics/skills.md#Athletics)), Dexterity ([Acrobatics](/📚%20-%20Information%20Compendium/📝%20-%20Rules%20&%20Mechanics/skills.md#Acrobatics)), and a special Constitution check that has a bonus equal to a roll of the character's largest Hit Die (this roll doesn't spend that die). If desired, the character can replace one of these skill checks with an attack roll using one of the character's weapons. The DC for each of the checks is `5 + 2d10`; generate a separate DC for each one. Consult the Pit Fighting Results table to see how the character did.

![Pit Fighting Results](/📚%20-%20Information%20Compendium/tables/pit-fighting-results-xge.md)
...
![Pit Fighting Complications](/📚%20-%20Information%20Compendium/tables/pit-fighting-complications-xge.md)