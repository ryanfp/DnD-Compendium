...
A creature who tries and fails to cast a spell from a [spell scroll](/📚%20-%20Information%20Compendium/items/spell-scroll.md) must make a DC 10 Intelligence saving throw. If the saving throw fails, roll on the Scroll Mishap table.
...
| dice: d6 | Result |
|----------|--------|
| 1 | A surge of magical energy deals the caster `d6` force damage per level of the spell. |
...
| 4 | The spell's effect is contrary to its normal one, but neither harmful nor beneficial. For instance, a [fireball](/📚%20-%20Information%20Compendium/spells/fireball.md) might produce an area of harmless cold. |
| 5 | The caster suffers a minor but bizarre effect related to the spell. Such effects last only as long as the original spell's duration, or `d10` minutes for spells that take effect instantaneously. For example, a [fireball](/📚%20-%20Information%20Compendium/spells/fireball.md) might cause smoke to billow from the caster's ears for `d10` minutes.  |
