...
For example, a 2nd-level rogue fires a [pistol](/📚%20-%20Information%20Compendium/items/pistol-toh.md) and scores a critical hit with sneak attack. The character rolls 4d6 damage dice that result in a 1, a 3, a 6 and another 6. The character then rerolls each 6, resulting in a 4 and a 6. The character adds those results to the current damage total for a final damage total of 26. Since the character's proficiency bonus is +2, the character can't reroll the new 6, ending the gunpowder bursts for that attack. When that character makes another attack with the [pistol](/📚%20-%20Information%20Compendium/items/pistol-toh.md), this process starts anew.
