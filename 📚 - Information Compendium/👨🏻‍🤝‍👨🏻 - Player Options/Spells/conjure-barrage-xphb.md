...
**Classes**: [Artificer (Battle Smith)](/3-Content/Compendiums/lists/list-spells-classes-battle-smith-tce.md "subclass=TCE;class=TCE"); [Bard](/3-Content/Compendiums/lists/list-spells-classes-bard.md); [Ranger](/3-Content/Compendiums/lists/list-spells-classes-ranger.md)
