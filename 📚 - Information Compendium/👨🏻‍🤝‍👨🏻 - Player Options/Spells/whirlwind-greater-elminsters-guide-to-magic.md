...
A creature restrained by the whirlwind can use an action to make a Strength or Dexterity check against the spellcaster's save DC. On a success, the creature is no longer restrained, and it is hurled `3d6 x 10` feet in a random direction. A thrown creature takes `d6` bludgeoning damage per 10 feet thrown if it strikes a solid object.
