...
**At Higher Levels.** When you cast this spell using a spell slot of 4th level or higher, the damage increases by `d8`, and the teleportation range increases by 10 feet, for each slot level above 3rd.
