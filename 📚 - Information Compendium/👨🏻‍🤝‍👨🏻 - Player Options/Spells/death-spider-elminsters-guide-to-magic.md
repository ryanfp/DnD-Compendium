...
You touch a creature, and it must immediately make a Wisdom saving throw. On a failed save, one of its limbs turns into a mindless, hairy spider. On the target's next turn, the spider twists around and starts to devour its host. The target then takes `d6` piercing damage at the start of each of its turns. 
