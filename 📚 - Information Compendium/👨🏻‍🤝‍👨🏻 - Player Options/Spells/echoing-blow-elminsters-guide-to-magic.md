...
**At Higher Levels.** At 5th level, the melee attack deals an extra `d6`  hunder damage to the target (whether or not it is concentrating on a spell). This extra damage increases to `2d6` at 11th level and `3d6` at 17th level.
