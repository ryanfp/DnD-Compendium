...
**At Higher Levels.** When you cast this spell using a spell slot of 3rd level or higher, the target can be pushed back an additional 5 feet for each slot level above 2nd, and takes an additional `d6` slashing damage for each slot level above 2nd. 

*Source: Valda's Spire of Secrets p. 336*