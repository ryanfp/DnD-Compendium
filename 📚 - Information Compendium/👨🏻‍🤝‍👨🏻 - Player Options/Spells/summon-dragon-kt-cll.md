...
You call forth a magical [dragon spirit](/3-Content/Compendiums/bestiary/dragon/dragon-spirit-kt-cll.md), which manifests in an unoccupied space that you can see within range. It uses the dragon spirit stat block, and you select one dragon color from the table below when you cast the spell. The creature resembles a dragon of that color, which determines certain traits in its stat block. The creature disappears when it drops to 0 hit points or when the spell ends.
