...
- **Range:** Self
- **Components:** S, M (scrap metal and wiring worth at least 30 gp, which the spell consumes)
- **Duration:** 1 hour
...
**At Higher Levels.** When you cast this spell using a spell slot of 3rd level or higher, the weapon's damage increases by `d6` for each slot level above 2nd (to a maximum of `5d6`). When you cast this spell using a spell slot of 4th level or higher, its duration increases to 8 hours.

*Source: The Ultimate Adventurer's Handbook p. 225*