...
**At Higher Levels.** When you cast this spell using a spell slot of 4th level or higher, the distance you can fling the target increases by 5 feet, and the damage from impacting a surface or creature increases by `d6` for each slot level above 3rd.

*Source: Tome of Heroes p. 299*