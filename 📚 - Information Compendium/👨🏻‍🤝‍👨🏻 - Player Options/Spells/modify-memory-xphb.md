...
A [Remove Curse](/3-Content/Compendiums/spells/remove-curse-xphb.md) or [Greater Restoration](/3-Content/Compendiums/spells/greater-restoration-xphb.md) spell cast on the target restores the creature's true memory.
...
**Classes**: [Wizard](/3-Content/Compendiums/lists/list-spells-classes-wizard.md); [Cleric (Trickery Domain)](/3-Content/Compendiums/lists/list-spells-classes-trickery-domain-xphb.md "subclass=XPHB;class=XPHB"); [Cleric (Trickery Domain)](/3-Content/Compendiums/lists/list-spells-classes-trickery-domain.md "class=XPHB"); [Bard](/3-Content/Compendiums/lists/list-spells-classes-bard.md); [Cleric (Trickery Domain)](/3-Content/Compendiums/lists/list-spells-classes-trickery-domain.md); [Warlock (Great Old One Patron)](/3-Content/Compendiums/lists/list-spells-classes-great-old-one-patron-xphb.md "subclass=XPHB;class=XPHB")
