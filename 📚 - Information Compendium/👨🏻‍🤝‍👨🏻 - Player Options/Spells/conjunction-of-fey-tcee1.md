...
- **Range:** 60 feet
- **Components:** V, S, M (an item originally from a plane of fey or dreams, worth at least 10 gp)
...
- You summon a [swarm of sprites](/3-Content/Compendiums/bestiary/fey/swarm-of-sprites-tcee1.md) in an unoccupied space of your choice within the cylinder. These sprites are hostile to all creatures in the area that are not Fey, and disappear when the spell ends or if they leave the cylinder.  

*Source: Tasha's Crucible of Everything Else - Volume 1 p. 57*