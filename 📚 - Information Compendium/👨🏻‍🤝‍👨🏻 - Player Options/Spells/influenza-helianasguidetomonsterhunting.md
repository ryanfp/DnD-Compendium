...
- ttrpg-cli/spell/subclass/necromancer
classes:
- Tamer (Necromancer)
aliases:
- Influenza
...
- **Duration:** Concentration, up to 1 mniute
...
**At Higher Levels.** When you cast this spell using a spell slot of 4th level or higher, the damage increases by `d6` and the value a poisoned creature must roll on the `d12` to cause a coughing fit increases by 1 for each slot level above 3rd.

**Classes**: [Tamer (Necromancer)](/3-Content/Compendiums/lists/list-spells-classes-necromancer-helianasguidetomonsterhunting.md "subclass=HelianasGuidetoMonsterHunting;class=HelianasGuidetoMonsterHunting")
