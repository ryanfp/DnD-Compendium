...
- **Range:** Self
- **Components:** V, S, M (bit of the chosen element from a plane other than where the spell is cast)
...
- Fire. You are immune to fire. Any creature that grapples you, or is within 5 feet of you when it hits you with an attack roll, takes `d6` fire damage. When you hit with an unarmed strike, you inflict an extra `d6` fire damage. 
...
*Source: Elminsters Guide to Magic v3 p. 45*