...
**At Higher Levels.** When you cast this spell using a spell slot of 4th level or higher, the radiant damage increases by `d8` for each slot level above 3rd, and if the spell's area overlaps with one or more areas of darkness created by spells of 2nd level or lower, those spells end immediately.

*Source: Elminsters Guide to Magic v3 p. 19*