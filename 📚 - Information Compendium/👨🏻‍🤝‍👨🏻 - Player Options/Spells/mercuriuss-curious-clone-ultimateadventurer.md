...
- The duplicate has a flying speed<sup><span title="Player's Handbook (2024)">'24</span></sup> of 30 feet, and its movement and actions make no noise unless you choose for them to do so, or a spell or ability requires it to speak or otherwise make noise.  
...
- The duplicate can't regain hit points through conventional means. Spells, potions, and class features fail to heal it, though you can use your bonus action and expend a spell slot to cause it to regain `d8` hit points per level of the expended spell slot. It also regains all of its hit points when you finish a short or long rest.  
