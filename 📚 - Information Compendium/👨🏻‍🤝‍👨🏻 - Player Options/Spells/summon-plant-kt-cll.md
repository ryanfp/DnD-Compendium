...
- ttrpg-cli/spell/subclass/elderheart
classes:
- Warden (Elderheart)
aliases:
- Summon Plant
...
You call forth a magical plant, which manifests in an unoccupied space that you can see within range. It uses the [Plant Spirit](/3-Content/Compendiums/bestiary/plant/plant-spirit-kt-cll.md) stat block, and you select either the Dryad, Shambling Mound, or Treant option when you cast the spell. The creature disappears when it drops to 0 hit points or when the spell ends.
...
**Classes**: [Warden (Elderheart)](/3-Content/Compendiums/lists/list-spells-classes-elderheart-kt-cll.md "subclass=KT-CLL;class=KT-CLL")
