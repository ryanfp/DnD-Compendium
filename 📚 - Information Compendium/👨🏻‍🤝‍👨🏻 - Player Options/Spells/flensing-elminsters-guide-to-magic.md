...
- First bonus action. The target must make a Constitution saving throw. If it fails, it takes `4d6` slashing damage, and its Charisma score is reduced by `d4`. If it succeeds, it takes half as much slashing damage, and its Charisma is unaffected. 
