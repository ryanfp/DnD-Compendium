---
title: Gloom Stalker 2024
created: 2025/06/15 at 15:37
updated: 2025/08/01 at 01:29
permalink: gloom-stalker-2024-ranger
...
At the start of your first turn of each combat, your [Speed](/3-Content/Rules/variant-rules/speed-xphb.md) increases by 10 feet until the end of that turn.
...
When you roll [Initiative](/3-Content/Rules/variant-rules/initiative-xphb.md), you can add your Wisdom modifier to the roll.
...
| Ranger Level | Spells |
|--------------|--------|
| 3rd | [Disguise Self](/3-Content/Compendiums/spells/disguise-self-xphb.md) |
| 5th | [Rope Trick](/3-Content/Compendiums/spells/rope-trick-xphb.md) |
...
You gain [Darkvision](/3-Content/Rules/senses.md#Darkvision) with a range of 60 feet. If you already have [Darkvision](/3-Content/Rules/senses.md#Darkvision) when you gain this feature, its range increases by 60 feet.

You are also adept at evading creatures that rely on [Darkvision](/3-Content/Rules/senses.md#Darkvision). While entirely in [Darkness](/3-Content/Rules/variant-rules/darkness-xphb.md), you have the [Invisible](/3-Content/Rules/conditions.md#Invisible) condition to any creature that relies on [Darkvision](/3-Content/Rules/senses.md#Darkvision) to see you in that [Darkness](/3-Content/Rules/variant-rules/darkness-xphb.md).
...
The target and each creature within 10 feet of it must make a Wisdom saving throw against your spell save DC. On a failed save, a creature has the [Frightened](/3-Content/Rules/conditions.md#Frightened) condition until the start of your next turn.

### Shadowy Dodge (Level 15)

When a creature makes an attack roll against you, you can take a [Reaction](/3-Content/Rules/variant-rules/reaction-xphb.md) to impose [Disadvantage](/3-Content/Rules/variant-rules/disadvantage-xphb.md) on that roll. Whether the attack hits or misses, you can then teleport up to 30 feet to an unoccupied space you can see.