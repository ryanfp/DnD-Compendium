...
The gods of this domain are often associated with knowledge, as learning and arcane power tend to go hand-in-hand. In the Realms, deities of this domain include [Azuth](/3-Content/Compendiums/deities/faerunian-azuth-scag.md) and [Mystra](/3-Content/Compendiums/deities/faerunian-mystra-scag.md), as well as Corellon Larethian of the elven pantheon. In other worlds, this domain includes [Hecate](/3-Content/Compendiums/deities/greek-hecate.md), [Math Mathonwy](/3-Content/Compendiums/deities/celtic-math-mathonwy.md), and [Isis](/3-Content/Compendiums/deities/egyptian-isis.md); the triple moon gods of Solinari, Lunitari, and Nuitari of Krynn; and Boccob, Vecna, and Wee Jas of Greyhawk.
...
| Cleric Level | Spells |
|--------------|--------|
| 1st | [detect magic](/3-Content/Compendiums/spells/detect-magic-xphb.md), [magic missile](/3-Content/Compendiums/spells/magic-missile-xphb.md) |
| 3rd | [magic weapon](/3-Content/Compendiums/spells/magic-weapon-xphb.md), [Nystul's magic aura](/3-Content/Compendiums/spells/nystuls-magic-aura-xphb.md) |
...
When you choose this domain at 1st level, you gain proficiency in the [Arcana](/3-Content/Rules/skills.md#Arcana) skill, and you gain two cantrips of your choice from the wizard spell list. For you, these cantrips count as cleric cantrips.
...
A turned creature must spend its turns trying to move as far away from you as it can, and it can't willingly end its move in a space within 30 feet of you. It also can't take reactions. For its action, it can use only the [Dash](/3-Content/Rules/actions.md#Dash) action or try to escape from an effect that prevents it from moving. If there's nowhere to move, then the creature can use the [Dodge](/3-Content/Rules/actions.md#Dodge) action.

After you reach 5th level, when a creature fails its saving throw against your Arcane Abjuration feature, the creature is banished for 1 minute (as in the [banishment](/3-Content/Compendiums/spells/banishment-xphb.md) spell, no [concentration](/3-Content/Rules/conditions.md#Concentration) required) if it isn't on its plane of origin, and its challenge rating is at or below a certain threshold, as shown below.
