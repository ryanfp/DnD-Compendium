...
updated: 2025/08/07 at 22:34
permalink: venomsmith-alchemist
...
> <tr class="class-progression"><td class"level">2nd</td><td class"pb">+2</td><td class"feature"><a href='#Venomsmith (Level 2)' class='internal-link'>Venomsmith</a></td></tr>
...
> <tr class="class-progression"><td class"level">18th</td><td class"pb">+6</td><td class"feature"><a href='#Toxic Recompense (Level 18)' class='internal-link'>Toxic Recompense</a></td></tr>
...
Beginning when you choose this field of study at 2nd level, you gain the [Poisoner](/3-Content/Compendiums/optional-features/poisoner-vss.md) discovery. Until you reach 3rd level, you have 2 reagent dice which can spend only on crafting poisons using this discovery. You can't later replace this discovery with a different one when you gain a level in this class.
