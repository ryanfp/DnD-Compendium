...
> <tr class="class-progression"><th class"level">Level</th><th class"pb">PB</th><th class"feature">Features</th><th class="value">Hemocraft Die</th><th class="value">Blood Curses Known</th></tr>
> </thead><tbody>
...
> <tr class="class-progression"><td class"level">3rd</td><td class"pb">+2</td><td class"feature"><a href='#Blood Hunter Order (Level 3)' class='internal-link'>Blood Hunter Order</a></td><td class="value">1d4</td><td class="value">1</td></tr>
> <tr class="class-progression"><td class"level">4th</td><td class"pb">+2</td><td class"feature"><a href='#Ability Score Improvement (Level 4)' class='internal-link'>Ability Score Improvement</a></td><td class="value">1d4</td><td class="value">1</td></tr>
> <tr class="class-progression"><td class"level">5th</td><td class"pb">+3</td><td class"feature"><a href='#Extra Attack (Level 5)' class='internal-link'>Extra Attack</a></td><td class="value">1d6</td><td class="value">1</td></tr>
> <tr class="class-progression"><td class"level">6th</td><td class"pb">+3</td><td class"feature"><a href='#Brand of Castigation (Level 6)' class='internal-link'>Brand of Castigation</a>, <a href='#Blood Maledict Improvement (Level 6)' class='internal-link'>Blood Maledict Improvement</a></td><td class="value">1d6</td><td class="value">2</td></tr>
> <tr class="class-progression"><td class"level">7th</td><td class"pb">+3</td><td class"feature"><a href='#Order feature (Level 7)' class='internal-link'>Order feature</a>, <a href='#Crimson Rite Improvement (Level 7)' class='internal-link'>Crimson Rite Improvement</a></td><td class="value">1d6</td><td class="value">2</td></tr>
> <tr class="class-progression"><td class"level">8th</td><td class"pb">+3</td><td class"feature"><a href='#Ability Score Improvement (Level 8)' class='internal-link'>Ability Score Improvement</a></td><td class="value">1d6</td><td class="value">2</td></tr>
> <tr class="class-progression"><td class"level">9th</td><td class"pb">+4</td><td class"feature"><a href='#Grim Psychometry (Level 9)' class='internal-link'>Grim Psychometry</a></td><td class="value">1d6</td><td class="value">2</td></tr>
> <tr class="class-progression"><td class"level">10th</td><td class"pb">+4</td><td class"feature"><a href='#Dark Augmentation (Level 10)' class='internal-link'>Dark Augmentation</a></td><td class="value">1d6</td><td class="value">3</td></tr>
> <tr class="class-progression"><td class"level">11th</td><td class"pb">+4</td><td class"feature"><a href='#Order feature (Level 11)' class='internal-link'>Order feature</a></td><td class="value">1d8</td><td class="value">3</td></tr>
> <tr class="class-progression"><td class"level">12th</td><td class"pb">+4</td><td class"feature"><a href='#Ability Score Improvement (Level 12)' class='internal-link'>Ability Score Improvement</a></td><td class="value">1d8</td><td class="value">3</td></tr>
> <tr class="class-progression"><td class"level">13th</td><td class"pb">+5</td><td class"feature"><a href='#Brand of Tethering (Level 13)' class='internal-link'>Brand of Tethering</a>, <a href='#Blood Maledict Improvement (Level 13)' class='internal-link'>Blood Maledict Improvement</a></td><td class="value">1d8</td><td class="value">3</td></tr>
> <tr class="class-progression"><td class"level">14th</td><td class"pb">+5</td><td class"feature"><a href='#Hardened Soul (Level 14)' class='internal-link'>Hardened Soul</a>, <a href='#Crimson Rite Improvement (Level 14)' class='internal-link'>Crimson Rite Improvement</a></td><td class="value">1d8</td><td class="value">4</td></tr>
> <tr class="class-progression"><td class"level">15th</td><td class"pb">+5</td><td class"feature"><a href='#Order feature (Level 15)' class='internal-link'>Order feature</a></td><td class="value">1d8</td><td class="value">4</td></tr>
> <tr class="class-progression"><td class"level">16th</td><td class"pb">+5</td><td class"feature"><a href='#Ability Score Improvement (Level 16)' class='internal-link'>Ability Score Improvement</a></td><td class="value">1d8</td><td class="value">4</td></tr>
> <tr class="class-progression"><td class"level">17th</td><td class"pb">+6</td><td class"feature"><a href='#Blood Maledict Improvement (Level 17)' class='internal-link'>Blood Maledict Improvement</a></td><td class="value">1d10</td><td class="value">4</td></tr>
> <tr class="class-progression"><td class"level">18th</td><td class"pb">+6</td><td class"feature"><a href='#Order feature (Level 18)' class='internal-link'>Order feature</a></td><td class="value">1d10</td><td class="value">5</td></tr>
> <tr class="class-progression"><td class"level">19th</td><td class"pb">+6</td><td class"feature"><a href='#Ability Score Improvement (Level 19)' class='internal-link'>Ability Score Improvement</a></td><td class="value">1d10</td><td class="value">5</td></tr>
> <tr class="class-progression"><td class"level">20th</td><td class"pb">+6</td><td class"feature"><a href='#Sanguine Mastery (Level 20)' class='internal-link'>Sanguine Mastery</a></td><td class="value">1d10</td><td class="value">5</td></tr>
> </tbody></table>
...
- **Skill Proficiencies**: *Choose 3:* [Acrobatics](/3-Content/Rules/skills.md#Acrobatics), [Arcana](/3-Content/Rules/skills.md#Arcana), [Athletics](/3-Content/Rules/skills.md#Athletics), [History](/3-Content/Rules/skills.md#History), [Insight](/3-Content/Rules/skills.md#Insight), [Investigation](/3-Content/Rules/skills.md#Investigation), [Religion](/3-Content/Rules/skills.md#Religion), or [Survival](/3-Content/Rules/skills.md#Survival)
...
- (a) [studded leather armor](/3-Content/Compendiums/items/studded-leather-armor.md) or (b) [scale mail](/3-Content/Compendiums/items/scale-mail.md) armor
- an [explorer's pack](/3-Content/Compendiums/items/explorers-pack-xphb.md) and [alchemist's supplies](/3-Content/Compendiums/items/alchemists-supplies-xphb.md)

Alternatively, you may start with 4d4 × 10 gp to buy your own equipment.

## Multiclassing Blood Hunter

**Ability Score Minimum:** Dexterity 13 or Strength 13

When you gain a level in a class other than your first, you gain only some of that class's starting proficiencies.

- **Skill Proficiencies**: *Choose 1:* [Acrobatics](/3-Content/Rules/skills.md#Acrobatics), [Arcana](/3-Content/Rules/skills.md#Arcana), [Athletics](/3-Content/Rules/skills.md#Athletics), [History](/3-Content/Rules/skills.md#History), [Insight](/3-Content/Rules/skills.md#Insight), [Investigation](/3-Content/Rules/skills.md#Investigation), [Religion](/3-Content/Rules/skills.md#Religion), or [Survival](/3-Content/Rules/skills.md#Survival)
...
At 1st level, you have survived the Hunter's Bane — a dangerous, long-guarded ritual that alters your life's blood, forever binding you to the darkness and honing your senses against it. You have advantage on Wisdom ([Survival](/3-Content/Rules/skills.md#Survival)) checks to track fey, fiends, or undead, as well as on Intelligence checks to recall information about such creatures.
...
<span class='abilityDc'>**Hemocraft save DC**: Wisdom or Intelligence + Proficiency Bonus</span>
...
The extra damage dealt by your rite is necrotic damage. (Prerequisite: 14th level)
...
The extra damage dealt by your rite is thunder damage. (Prerequisite: 14th level)
...
Your brand lasts until you dismiss it or until you use this feature to apply a brand to another creature. Your brand can be dispelled with [dispel magic](/3-Content/Compendiums/spells/dispel-magic-xphb.md), and is treated as a spell with a level equal to half your blood hunter level (maximum 9th level).

Once you use this feature, you can't use it again until you finish a short or long rest.

### Blood Maledict Improvement (Level 6)
...
### Crimson Rite Improvement (Level 7)

At 7th level, you learn an additional Crimson Rite.
...
When you reach 9th level, you gain a supernatural talent for discerning the secrets surrounding mysterious relics or places touched by evil. Whenever you make an Intelligence ([History](/3-Content/Rules/skills.md#History)) check to recall information about the sinister or tragic history of an object you are touching or your current location, you have advantage on the check. At the DM's discretion, a suitably high roll might cause your character to experience brief visions of the past connected to the object or location.
...
### Blood Maledict Improvement (Level 13)

Beginning at 13th level, you can use your Blood Maledict feature three times between rests.

### Hardened Soul (Level 14)

When you reach 14th level, you have advantage on saving throws against being [charmed](/3-Content/Rules/conditions.md#Charmed) and [frightened](/3-Content/Rules/conditions.md#Frightened).

### Crimson Rite Improvement (Level 14)
...
### Blood Maledict Improvement (Level 17)
...
> [!example]- Optional Features: Blood Curse
> ![Blood Curse](/3-Content/Compendiums/lists/list-optfeaturetype-bc.md#Blood%20Curse)
^list-optfeature-bc

> [!example]- Optional Features: Crimson Rite
> ![Crimson Rite](/3-Content/Compendiums/lists/list-optfeaturetype-cr.md#Crimson%20Rite)
^list-optfeature-cr

> [!example]- Optional Features: Fighting Style, Fighter
> ![Fighting Style, Fighter](/3-Content/Compendiums/lists/list-optfeaturetype-fs-f.md#Fighting%20Style,%20Fighter)
