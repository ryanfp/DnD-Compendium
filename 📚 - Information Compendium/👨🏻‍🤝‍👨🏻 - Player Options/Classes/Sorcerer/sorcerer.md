...
- **Armor**: none
- **Weapons**: [daggers](/3-Content/Compendiums/items/dagger.md), [darts](/3-Content/Compendiums/items/dart.md), [slings](/3-Content/Compendiums/items/sling.md), [quarterstaffs](/3-Content/Compendiums/items/quarterstaff.md), [light crossbows](/3-Content/Compendiums/items/light-crossbow.md)
- **Tools**: none
- **Skills**: choose 2 from [Arcana](/3-Content/Rules/skills.md#Arcana), [Deception](/3-Content/Rules/skills.md#Deception), [Insight](/3-Content/Rules/skills.md#Insight), [Intimidation](/3-Content/Rules/skills.md#Intimidation), [Persuasion](/3-Content/Rules/skills.md#Persuasion), and [Religion](/3-Content/Rules/skills.md#Religion)
...
- Two [daggers](/3-Content/Compendiums/items/dagger.md)
...
You can make a sorcerer quickly by following these suggestions. First, Charisma should be your highest ability score, followed by Constitution. Second, choose the hermit background. Third, choose the [light](/3-Content/Compendiums/spells/light-xphb.md), [prestidigitation](/3-Content/Compendiums/spells/prestidigitation-xphb.md), [ray of frost](/3-Content/Compendiums/spells/ray-of-frost-xphb.md), and [shocking grasp](/3-Content/Compendiums/spells/shocking-grasp-xphb.md) cantrips, along with the 1st-level spells [shield](/3-Content/Compendiums/spells/shield-xphb.md) and [magic missile](/3-Content/Compendiums/spells/magic-missile-xphb.md).
...
For example, if you know the 1st-level spell [burning hands](/3-Content/Compendiums/spells/burning-hands-xphb.md) and have a 1st-level and a 2nd-level spell slot available, you can cast [burning hands](/3-Content/Compendiums/spells/burning-hands-xphb.md) using either slot.
...
You can use an [arcane focus](/3-Content/Compendiums/items/arcane-focus-xphb.md) as a spellcasting focus for your sorcerer spells.
...
- [Careful Spell](/3-Content/Compendiums/optional-features/careful-spell-xphb.md)  
- [Distant Spell](/3-Content/Compendiums/optional-features/distant-spell-xphb.md)  
- [Empowered Spell](/3-Content/Compendiums/optional-features/empowered-spell-xphb.md)  
- [Extended Spell](/3-Content/Compendiums/optional-features/extended-spell-xphb.md)  
- [Heightened Spell](/3-Content/Compendiums/optional-features/heightened-spell-xphb.md)  
- [Quickened Spell](/3-Content/Compendiums/optional-features/quickened-spell-xphb.md)  
- [Subtle Spell](/3-Content/Compendiums/optional-features/subtle-spell-xphb.md)  
...
- Replace one of the options you chose for the Metamagic feature with a different [Metamagic option](/3-Content/Compendiums/lists/list-optfeaturetype-mm.md) available to you.  
