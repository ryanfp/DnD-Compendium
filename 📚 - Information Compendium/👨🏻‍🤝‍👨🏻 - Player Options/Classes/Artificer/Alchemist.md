...
When you adopt this specialization at 3rd level, you gain proficiency with [alchemist's supplies](/3-Content/Compendiums/items/alchemists-supplies-xphb.md). If you already have this proficiency, you gain proficiency with one other type of [artisan's tools](/3-Content/Compendiums/items/artisans-tools-xphb.md) of your choice.
...
|-----------------|-------|
| 3rd | [healing word](/3-Content/Compendiums/spells/healing-word-xphb.md), [ray of sickness](/3-Content/Compendiums/spells/ray-of-sickness-xphb.md) |
| 5th | [flaming sphere](/3-Content/Compendiums/spells/flaming-sphere-xphb.md), [Melf's acid arrow](/3-Content/Compendiums/spells/melfs-acid-arrow-xphb.md) |
...
Beginning at 3rd level, whenever you finish a long rest, you can magically produce an *experimental elixir* in an empty flask you touch. Roll on the Experimental Elixir table for the elixir's effect, which is triggered when someone drinks the elixir. As an action, a creature can drink the elixir or administer it to an [incapacitated](/3-Content/Rules/conditions.md#Incapacitated) creature.

Creating an *experimental elixir* requires you to have [alchemist's supplies](/3-Content/Compendiums/items/alchemists-supplies-xphb.md) on your person, and any elixir you create with this feature lasts until it is drunk or until the end of your next long rest.
