---
title: Circle of the Moon 2024
created: 2025/06/15 at 15:35
updated: 2025/08/01 at 01:10
permalink: circle-of-moon-2024-druid
...
|-------------|-----------------|
| 3 | [Cure Wounds](/3-Content/Compendiums/spells/cure-wounds-xphb.md), [Moonbeam](/3-Content/Compendiums/spells/moonbeam-xphb.md), [Starry Wisp](/3-Content/Compendiums/spells/starry-wisp-xphb.md) |
...
The maximum [Challenge Rating](/3-Content/Rules/variant-rules/challenge-rating-xphb.md) for the form equals your Druid level divided by 3 (round down).
...
You gain a number of [Temporary Hit Points](/3-Content/Rules/variant-rules/temporary-hit-points-xphb.md) equal to three times your Druid level.
...
You magically transport yourself, reappearing amid a burst of moonlight. As a [Bonus Action](/3-Content/Rules/variant-rules/bonus-action-xphb.md), you teleport up to 30 feet to an unoccupied space you can see, and you have [Advantage](/3-Content/Rules/variant-rules/advantage-xphb.md) on the next attack roll you make before the end of this turn.

You can use this feature a number of times equal to your Wisdom modifier (minimum of once), and you regain all expended uses when you finish a [Long Rest](/3-Content/Rules/variant-rules/long-rest-xphb.md). You can also regain uses by expending a level 2+ spell slot for each use you want to restore (no action required).
