...
tags: [ttrpg-cli/compendium/src/5e/phb, ttrpg-cli/subclass/rogue/assassin]
aliases:
  - Assassin
...
Starting at 3rd level, you are at your deadliest when you get the drop on your enemies. You have advantage on attack rolls against any creature that hasn't taken a turn in the combat yet. In addition, any hit you score against a creature that is [surprised](/3-Content/Rules/conditions.md#Surprised) is a critical hit.

### Bonus Proficiencies (Level 3)

When you choose this archetype at 3rd level, you gain proficiency with the [disguise kit](/3-Content/Compendiums/items/disguise-kit-xphb.md) and the [poisoner's kit](/3-Content/Compendiums/items/poisoners-kit-xphb.md).
...
Your ruse is indiscernible to the casual observer. If a wary creature suspects something is amiss, you have advantage on any Charisma ([Deception](/3-Content/Rules/skills.md#Deception)) check you make to avoid detection.

### Death Strike (Level 17)

Starting at 17th level, you become a master of instant death. When you attack and hit a creature that is [surprised](/3-Content/Rules/conditions.md#Surprised), it must make a Constitution saving throw (DC 8 + your Dexterity modifier + your proficiency bonus). On a failed save, double the damage of your attack against the creature.