...
tags: [ttrpg-cli/compendium/src/5e/vss, ttrpg-cli/subclass/gunslinger/spellslinger]
aliases:
  - Spellslinger Creed
  - Spellslinger
...
> <tr class="class-progression"><td class"level">3rd</td><td class"pb">+2</td><td class"feature"><a href='#Spellslinger (Level 3)' class='internal-link'>Spellslinger</a></td><td class="value">3</td><td class="value">3</td><td class="spellSlot">2</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td></tr>
...
> <tr class="class-progression"><td class"level">7th</td><td class"pb">+3</td><td class"feature"><a href='#Spellshot (Level 7)' class='internal-link'>Spellshot</a>, <a href='#Rune-Carved Cartridges (Level 7)' class='internal-link'>Rune-Carved Cartridges</a></td><td class="value">3</td><td class="value">5</td><td class="spellSlot">4</td><td class="spellSlot">2</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td></tr>
...
> <tr class="class-progression"><td class"level">9th</td><td class"pb">+4</td><td class"feature"></td><td class="value">3</td><td class="value">6</td><td class="spellSlot">4</td><td class="spellSlot">2</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td></tr>
> <tr class="class-progression"><td class"level">10th</td><td class"pb">+4</td><td class"feature"><a href='#Magic Bullet (Level 10)' class='internal-link'>Magic Bullet</a></td><td class="value">4</td><td class="value">7</td><td class="spellSlot">4</td><td class="spellSlot">3</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td></tr>
...
> <tr class="class-progression"><td class"level">13th</td><td class"pb">+5</td><td class"feature"></td><td class="value">4</td><td class="value">9</td><td class="spellSlot">4</td><td class="spellSlot">3</td><td class="spellSlot">2</td><td class="spellSlot">⏤</td></tr>
> <tr class="class-progression"><td class"level">14th</td><td class"pb">+5</td><td class"feature"><a href='#Improved Spellshot (Level 14)' class='internal-link'>Improved Spellshot</a></td><td class="value">4</td><td class="value">10</td><td class="spellSlot">4</td><td class="spellSlot">3</td><td class="spellSlot">2</td><td class="spellSlot">⏤</td></tr>
...
> <tr class="class-progression"><td class"level">17th</td><td class"pb">+6</td><td class"feature"></td><td class="value">4</td><td class="value">11</td><td class="spellSlot">4</td><td class="spellSlot">3</td><td class="spellSlot">3</td><td class="spellSlot">⏤</td></tr>
...
You learn [finger guns](/3-Content/Compendiums/spells/finger-guns-vss.md) and two other cantrips of your choice from the wizard spell list. You learn an additional wizard cantrip of your choice at 10th level.

#### Spell Slots

The Spellslinger Spellcasting table shows how many spell slots you have to cast your spells of 1st level and higher. To cast one of these spells, you must expend a slot of the spell's level or higher. You regain all expended spell slots when you finish a long rest.
...
### Bang, You're Dead! (Level 3)

At 3rd level, you can use Deeds with [finger guns](/3-Content/Compendiums/spells/finger-guns-vss.md) spell attacks. Additionally, when you hit a target with a [finger guns](/3-Content/Compendiums/spells/finger-guns-vss.md) attack, you can spend a risk die as a bonus action to deal an extra 1d8 force damage to the target.

### Spellshot (Level 7)

Beginning at 7th level, you can load an entire cantrip into your gun. When you use your action to cast a cantrip, you can use your bonus action to make one ranged attack with a firearm or make a ranged spell attack using the [finger guns](/3-Content/Compendiums/spells/finger-guns-vss.md) cantrip.

### Rune-Carved Cartridges (Level 7)

Also at 7th level, firearms you use count as magical for the purpose of overcoming resistance and immunity to nonmagical attacks and damage.

### Magic Bullet (Level 10)

Starting at 10th level, you can use your action to fire a bullet wreathed in the evocation of a magic missile spell. The attack must use a firearm and the target must be within the firearm's normal range. Do not roll this attack; it automatically hits its target and deals force damage.

Once you use this feature, you can't use it again until you finish a long rest.

### Improved Spellshot (Level 14)

At 14th level, when you use your action to cast a spell, you can expend one risk die as a bonus action to make one ranged attack with a firearm or make a ranged spell attack using the [finger guns](/3-Content/Compendiums/spells/finger-guns-vss.md) cantrip.
