...
permalink: scoundrel-backgrounds
...
`dice: [](scoundrel-toh.md#^personality-trait)`
...
`dice: [](scoundrel-toh.md#^ideal)`

| dice: d6 | Ideal |
|----------|-------|
| 1 | **Freedom.** Ropes and chains are made to be broken. Locks are made to be picked. Doors are meant to be opened. (Chaotic) |
| 2 | **Community.** I never let passion, preference, or emotion influence my decision-making or clear headedness. (Lawful) |
