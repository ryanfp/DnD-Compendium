...
*Source: Exploring Eberron p. 207*  

- **Skill Proficiencies.** Deception, Insight  
- **Tool Proficiencies.** thieves' tools, poisoner's kit, or forgery kit  
- **Languages.** Sahuagin  
- **Equipment.** A seashell, a set of traveler's clothes, and a purse containing 30gp, which can be used on equpiment needed to match your victim's identity.  
...
`dice: [](malenti-exploringeberron.md#^tour-of-duty)`

| dice: d6 | Tour of Duty |
|----------|--------------|
| 1 | You replaced your victim in their youth, and have a well-established relationship with family and friends. |
...
`dice: [](malenti-exploringeberron.md#^personality-trait)`
...
`dice: [](malenti-exploringeberron.md#^ideal)`
...
`dice: [](malenti-exploringeberron.md#^bond)`
...
`dice: [](malenti-exploringeberron.md#^flaw)`
