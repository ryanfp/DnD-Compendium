...
---
# Forest dweller
*Source: Tome of Heroes p. 161*  


- **Skill Proficiencies.** Nature, Survival  
- **Tool Proficiencies.** Woodcarver's tools, herbalism kit  
- **Languages.** Sylvan  
- **Equipment.** A set of common clothes, a hunting trap, a wooden staff, a whetstone, an explorer's pack, and a pouch containing 5 gp  
...
`dice: [](forest-dweller-toh.md#^event)`
...
`dice: [](forest-dweller-toh.md#^personality-trait)`
...
`dice: [](forest-dweller-toh.md#^ideal)`
...
`dice: [](forest-dweller-toh.md#^bond)`
...
`dice: [](forest-dweller-toh.md#^flaw)`
