...
- **Languages.** Skin cant  
- **Equipment.** A shiftweave garment (capable of shifting between five different outfits), one trinkit of special significance, and a belt pouch containing 5 gp  
...
`dice: [](changeling-traveler-exploringeberron.md#^personas)`
...
`dice: [](changeling-traveler-exploringeberron.md#^personality-trait)`
...
`dice: [](changeling-traveler-exploringeberron.md#^ideal)`
...
`dice: [](changeling-traveler-exploringeberron.md#^bond)`
...
`dice: [](changeling-traveler-exploringeberron.md#^flaw)`
