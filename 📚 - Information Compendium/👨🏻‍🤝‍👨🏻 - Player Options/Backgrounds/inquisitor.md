...
permalink: inquisitor-backgrounds
...
*Source: Steinhardt's Guide to the Eldritch Hunt p. 179*  
![](/📚%20-%20Information%20Compendium/books/steinhardts-guide-to-the-eldritch-hunt/img/04430.webp#right)

- **Skill Proficiencies.** Religion, Intimidation  
- **Tool Proficiencies.** [Torture tools](/📚%20-%20Information%20Compendium/items/torture-tools-sgtteh.md) […] ^[The following text has been removed with this homebrew: (SGttEH Page 156)]  
...
- **Equipment.** A holy symbol of the Radiant Church, a set of common clothes, a set of manacles, [torture tools](/📚%20-%20Information%20Compendium/items/torture-tools-sgtteh.md), a tome containing the teachings of the Radiant Church, and a pouch containing 10 gp  
...
Your place within the Radiant Church is unique and carries with it heavy responsibilities. The pursuit of truth and the maintenance of the Church's authority guide your actions, though the means you use to achieve these ends can be unsavory.

**Personality Traits**

`dice: [](inquisitor-sgtteh.md#^personality-traits)`
...
`dice: [](inquisitor-sgtteh.md#^ideals)`
...
`dice: [](inquisitor-sgtteh.md#^bonds)`
...
`dice: [](inquisitor-sgtteh.md#^flaws)`
...
| 6 | I sometimes resort to extreme measures in the name of preserving the Church, which can lead to unnecessary conflict. |
