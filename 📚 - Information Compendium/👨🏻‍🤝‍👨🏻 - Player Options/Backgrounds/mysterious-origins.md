...
permalink: mysterious-origins-backgrounds
source: Tome of Heroes
aliases:
  - Mysterious Origins
  - mysterious-origins-toh
tags:
  - background
  - 
...
- **Equipment.** A mysterious trinket from your past life, a set of artisan's tools or a musical instrument (one of your choice), a set of common clothes, and a belt pouch containing 5 gp  
...
`dice: [](mysterious-origins-toh.md#^personality-trait)`
...
`dice: [](mysterious-origins-toh.md#^ideal)`
...
`dice: [](mysterious-origins-toh.md#^bond)`
...
`dice: [](mysterious-origins-toh.md#^flaw)`
