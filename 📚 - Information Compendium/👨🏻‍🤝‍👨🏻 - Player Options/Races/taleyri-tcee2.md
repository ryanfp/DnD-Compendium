...
- **Ability Scores**: Dexterity +1; Wisdom +1; Strength +1
- **Size**: Medium
- **Speed**: walk: 30 ft.
...
When you make an attack roll, ability check, or saving throw, you can roll `d6` and add it to the total. You can do this after seeing the die roll, but must use it before learning whether the roll is a success or failure. Once you use this ability, you can't do so again until you finish a short or long rest.
