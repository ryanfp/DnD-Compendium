...
tags:
- 
- race/halfling/hinterfolk
aliases:
- Halfling (Hinterfolk)
---
# Halfling (Hinterfolk)
*Source: Tome of Heroes p. 38*  
...
Aleki, Aonani, Enele, Makane, Tamo, Tane

##### Female Names

Arihi, Elei, Manaia, Natia, Sefina, Wiki

##### Clan Names

Atalafo (Shadowstalker), Halapono (Wise Ways), Lauoso (Treeleaper), Luko'ato (Wolf Pack), Mana'ago (Powerful Spirit), Tematagi (Windrider)
...
Your base walking speed is 30 feet. When wearing light or no armor, you have a climbing speed of 20 feet and a swimming speed of 20 feet.
