...
- race/dwarf/ruinbound
aliases:
- Dwarf (Ruinbound)
---
# Dwarf (Ruinbound)
*Source: Exploring Eberron p. 18*  
...
You are bound to an alien entity. It's part of your body and can't be removed. Your symbiont possesses a minor supernatural ability, which it can use on your behalf.
...
You can attune to one magic item that has the Symbiotic Nature property without using an attunement slot. In addition, after you finish a long rest, you can end your attunement to a magic item that has the Symbiotic Nature property.
...
`dice: [](dwarf-ruinbound-exploringeberron.md#^ruinbound-mutations)`

| dice: d8 | Ruinbound Mutations |
|----------|---------------------|
