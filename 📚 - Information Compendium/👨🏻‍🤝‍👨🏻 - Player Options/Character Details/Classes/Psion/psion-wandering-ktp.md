...
---
# Wandering
*[Psion](./psion-ktp.md): Psionic Archetype*  
...
> </thead><tbody>
> <tr class="class-progression"><td class"level">1st</td><td class"pb">+2</td><td class"feature"><a href='#Wandering Mind (Level 1)' class='internal-link'>Wandering Mind</a></td></tr>
> <tr class="class-progression"><td class"level">2nd</td><td class"pb">+2</td><td class"feature"></td></tr>
> <tr class="class-progression"><td class"level">3rd</td><td class"pb">+2</td><td class"feature"><a href='#Cunning Strikes (Level 3)' class='internal-link'>Cunning Strikes</a>, <a href='#Curious Mind (Level 3)' class='internal-link'>Curious Mind</a></td></tr>
> <tr class="class-progression"><td class"level">4th</td><td class"pb">+2</td><td class"feature"></td></tr>
> <tr class="class-progression"><td class"level">5th</td><td class"pb">+3</td><td class"feature"></td></tr>
> <tr class="class-progression"><td class"level">6th</td><td class"pb">+3</td><td class"feature"><a href='#Phase Dancer (Level 6)' class='internal-link'>Phase Dancer</a></td></tr>
> <tr class="class-progression"><td class"level">7th</td><td class"pb">+3</td><td class"feature"></td></tr>
> <tr class="class-progression"><td class"level">8th</td><td class"pb">+3</td><td class"feature"></td></tr>
> <tr class="class-progression"><td class"level">9th</td><td class"pb">+4</td><td class"feature"></td></tr>
> <tr class="class-progression"><td class"level">10th</td><td class"pb">+4</td><td class"feature"><a href='#Flickering Presence (Level 10)' class='internal-link'>Flickering Presence</a></td></tr>
> <tr class="class-progression"><td class"level">11th</td><td class"pb">+4</td><td class"feature"></td></tr>
> <tr class="class-progression"><td class"level">12th</td><td class"pb">+4</td><td class"feature"></td></tr>
> <tr class="class-progression"><td class"level">13th</td><td class"pb">+5</td><td class"feature"></td></tr>
> <tr class="class-progression"><td class"level">14th</td><td class"pb">+5</td><td class"feature"><a href='#Planeswalker (Level 14)' class='internal-link'>Planeswalker</a>, <a href='#Winding Paths (Level 14)' class='internal-link'>Winding Paths</a></td></tr>
...
At 1st level when you select this archetype, your mind grows a greater perspective on the nature of space and dimensions, allowing you to manipulate it and your relation to it, granting you the psionic [discipline of Transposition](/3-Content/Compendiums/optional-features/transposition-discipline-ktp.md).
...
### Phase Dancer (Level 6)

Starting at 6th level, once per turn, you automatically gain one illusory duplicate as per the blurring modifier when you use your [Phase Rift](/3-Content/Compendiums/optional-features/transposition-discipline-ktp.md) power. Additionally, your first attack roll before the end of your turn after using [Phase Rift](/3-Content/Compendiums/optional-features/transposition-discipline-ktp.md) gains advantage.

### Flickering Presence (Level 10)

Starting at 10th level, your unspent Psionic Mastery points are not lost until the start of your next turn, but can only be used to cast [flicker](/3-Content/Compendiums/spells/flicker-ktp.md).

Additionally, when you roll for the effect of [flicker](/3-Content/Compendiums/spells/flicker-ktp.md) or [blink](/3-Content/Compendiums/spells/blink-xphb.md) you can expend 1 psi point to reroll the result. You can select which of the two results you would like to use.

### Planeswalker (Level 14)

Starting at 14th level, your understanding of how to traverse space expands to a previously incomprehensible scale. You gain the ability to cast [plane shift](/3-Content/Compendiums/spells/plane-shift-xphb.md) and [teleport](/3-Content/Compendiums/spells/teleport-xphb.md). You can cast one of these spells per day once without expending a spell slot or use of Innate Psionics. Once you do this, you must finish a long rest before you can use them again, or use your 7th level or higher use of Innate Psionics instead of the spell selected for that level to cast these spells again before finishing a long rest. If you already have one of these spells selected for your 7th level Innate psionic power, you can select a new 7th-level spell from the psion list for that slot. Material components are still required for casting plane shift this way.

### Winding Paths (Level 14)

Additionally at 14th level, your [Phase Rift](/3-Content/Compendiums/optional-features/transposition-discipline-ktp.md) no longer has to go in a straight line, though it can only pass through a creature's space once.