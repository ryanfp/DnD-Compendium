...
Your army is made up of units. Each unit has a card with stats, and its status is tracked with a casualty die. Let's take a look at a typical unit card: [Ironheart Defenders](/📚%20-%20Information%20Compendium/optional-features/ironheart-defenders-saf.md)
...
| Hurl Rocks | If this unit succeeds on an Attack check, it inflicts 2 casualties.  Against fortifications it inflicts `d6` casualties. | 250 |
...
![Unit Size](/📚%20-%20Information%20Compendium/tables/unit-size-saf.md)
...
[Rockbreakers](/📚%20-%20Information%20Compendium/optional-features/rockbreakers-saf.md)
...
![Sample Attitude Chart](/📚%20-%20Information%20Compendium/tables/sample-attitude-chart-saf.md)
...
> Lindsay's `d8` unit of heavy infantry suffers three casualties in a battle, reducing it to size 5. If she fights another battle this day, the unit is fielded with size 5. The next day it recovers one casualty. It is now a size 6 unit, and stops recovering.