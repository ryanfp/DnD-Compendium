...
- [ ] Add multiple new conditions and interactions between them with existing mechanics/spells (Condition)
	...
	- [ ] Burning/Burned = take 1d4 Fire damage at the start of each turn, unless a feature or ability says otherwise (can give higher die, like d6). Anyone can spend an Action to clear the condition. When a creature that is Burning successfully grapples another creature, they obtain the Burning condition as well. 
	...
	- [ ] Corroded = -2 AC for duration. You can also spend an action to clear the condition, or clear the condition when gaining the Wet condition. 
	...
	- [ ] Silenced/Disrupted/Splintered/Stupefied = some kind of condition that doesn’t let you cast spells period, or gives you a debuff to all spells. 
