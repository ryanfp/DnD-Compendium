...
At 3rd level, you gain the ability to decipher an opponent's tactics and develop a counter to them. As a bonus action, you can make a Wisdom ([Insight](skills.md#Insight)) check against a creature you can see that isn't [incapacitated](conditions.md#Incapacitated), contested by the target's Charisma ([Deception](skills.md#Deception)) check. If you succeed, you can use your Sneak Attack against that target even if you don't have advantage on the attack roll, but not if you have disadvantage on it.
