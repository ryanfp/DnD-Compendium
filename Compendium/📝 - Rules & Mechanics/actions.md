...
A [whipsaw](/📚%20-%20Information%20Compendium/items/whipsaw-toh.md) isn't a true whip and can't be used to perform this weapon option. You can use the [pull](actions.md#Pull) weapon option on a creature you have leashed, and you have advantage on the attack roll, provided you use the whip that is leashing the target to perform the pullweapon option.
