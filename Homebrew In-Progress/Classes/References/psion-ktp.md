...
> <tr class="class-progression"><th class"level">Level</th><th class"pb">PB</th><th class"feature">Features</th><th class="value">Psi Points</th><th class="value">Per Use Limit</th><th class="value"><a href="/3-Mechanics/CLI/lists/list-optfeaturetype-psit.md">Psionic Talents</a></th></tr>
> </thead><tbody>
...
- **Skill Proficiencies**: *Choose 2:* Deception, History, Insight, Intimidation, Investigation, Medicine, Perception, or Religion
...
Starting at 1st level, you gain access to psi points used to fuel [psionic discipline](/3-Mechanics/CLI/lists/list-optfeaturetype-psid.md) powers and effects. You have a number of psi points equal to your psion level, and you regain all spent points when you finish a short or long rest. You can spend a number of psi points equal to half your Psion level (rounded up) at a time. For example, if you're a 5th-level Psion, you can spend 3 psi points on a psionic power or cast a spell with a cost of 3 psi points.
...
Starting at 2nd level, you gain access to a psionic talent allowing you to further specialize. Pick two talents from the list of [Psionic Talents](/3-Mechanics/CLI/lists/list-optfeaturetype-psit.md) presented at the end of the class description.
...
When you reach 3rd level, you can select a second psionic discipline from the list of [psionic disciplines](/3-Mechanics/CLI/lists/list-optfeaturetype-psid.md). You can't select a Discipline you already know. You gain all features of a psionic discipline when selecting it.
...
When you reach 18th level, you can select a third psionic discipline from the list of [psionic disciplines](/3-Mechanics/CLI/lists/list-optfeaturetype-psid.md). You can't select a discipline you already know. You gain all features of a psionic discipline when selecting it.
