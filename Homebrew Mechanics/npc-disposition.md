...
- The DCs for the rolls start at 15, and increase or decrease based on disposition
- DCs are determined by the argument and if it appeals to Motivation or Pitfall (DC10 if Motivation, DC20 if Pitfalls, DC15 otherwise)
- Checks are given Advantage/Disadvantage based on if they appealed to a Motivation/Pitfalls, respectively.