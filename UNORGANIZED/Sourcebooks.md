...
DM’s Guild <sup>(DMSG)</sup>
	...
	[[Exploring Eberron]] <sup>(EE)</sup>
	Frontiers of Eberron: Quickstone <sup>(FEQ)</sup>
	Tasha’s Crucible of Everything Else <sup>(TCEE)</sup>
	The Ultimate Adventurer’s Handbook <sup>(UAH)</sup> = Newer The Complete DEVOUT Handbook 
...
Exandria Unlimited <sup>(EXU)</sup>
	Tal’Dorei Campaign Setting Reborn <sup>(TDR)</sup>
...
| Notation | Abbreviation | Long name                                             | Source | Type      |
| -------- | ------------ | ----------------------------------------------------- | ------ | --------- |
| (AAG)    | AAG          | Astral Adventurer's Guide                             |        | book      |
| (AATM)   | AATM         | Adventure Atlas: The Mortuary                         |        | book      |
