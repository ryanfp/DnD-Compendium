...
> <tr class="class-progression"><th class"level">Level</th><th class"pb">PB</th><th class"feature">Features</th><th class="value"><a href="/3-Content/Compendiums/lists/list-optfeaturetype-ktor.md">Occult Rites</a></th><th class="value">Cantrips Known</th><th class="value">Spells Known</th><th class="value">1st</th><th class="value">2nd</th><th class="value">3rd</th><th class="value">4th</th><th class="value">5th</th><th class="value">6th</th><th class="value">7th</th><th class="value">8th</th><th class="value">9th</th></tr>
> </thead><tbody>
...
> <tr class="class-progression"><td class"level">4th</td><td class"pb">+2</td><td class"feature"><a href='#Ability Score Improvement (Level 4)' class='internal-link'>Ability Score Improvement</a></td><td class="value">2</td><td class="value">3</td><td class="value">6</td><td class="value">4</td><td class="value">3</td><td class="value">⏤</td><td class="value">⏤</td><td class="value">⏤</td><td class="value">⏤</td><td class="value">⏤</td><td class="value">⏤</td><td class="value">⏤</td></tr>
...
- **Skill Proficiencies**: *Choose 2:* [Animal Handling](/3-Content/Rules/skills.md#Animal%20Handling), [Arcana](/3-Content/Rules/skills.md#Arcana), [Deception](/3-Content/Rules/skills.md#Deception), [History](/3-Content/Rules/skills.md#History), [Investigation](/3-Content/Rules/skills.md#Investigation), [Medicine](/3-Content/Rules/skills.md#Medicine), [Nature](/3-Content/Rules/skills.md#Nature), [Religion](/3-Content/Rules/skills.md#Religion), [Sleight of Hand](/3-Content/Rules/skills.md#Sleight%20of%20Hand), [Stealth](/3-Content/Rules/skills.md#Stealth), or [Survival](/3-Content/Rules/skills.md#Survival)
- **Weapon Proficiencies**: [Daggers](/3-Content/Compendiums/items/dagger.md), [quarterstaffs](/3-Content/Compendiums/items/quarterstaff.md), and [light crossbows](/3-Content/Compendiums/items/light-crossbow.md)
...
- (a) a [quarterstaff](/3-Content/Compendiums/items/quarterstaff.md), (b) a [dagger](/3-Content/Compendiums/items/dagger.md), or (c) one simple weapon
- (a) a [component pouch](/3-Content/Compendiums/items/component-pouch-xphb.md) or (b) an [occult fetish](/3-Content/Compendiums/items/occult-fetish-kt-o.md)
...
- (a) [leather armor](/3-Content/Compendiums/items/leather-armor.md), or (b) [scale mail](/3-Content/Compendiums/items/scale-mail.md), (if proficient)
- A [Herbalism kit](/3-Content/Compendiums/items/herbalism-kit-xphb.md).
...
The woods creak and bend, black wings beating as raven alights on the outstretch hand of an ancient elf, her eyes as black as the raven's. Soft words are spoken, and the elf nods in agreement.
...
Occultists are spell casters following legacies that go far back. While they may or may not be directly tutored or influence by another member of their tradition, their path to magic involves unearthing ancient secrets, old ways, and knowledge gleaned from spirits, ghosts, and elementals.

The often personify aspects of their magic in ways that other casters find odd, coaxing and manipulating magic forces by ancient laws and bargains. Occultists tread between the arcane and the divine, not necessarily worshiping any god, but treating gods and spirits alike with cautious respect for their domains, asking for the what they take, and carefully giving thought to their actions.
...
You can make an Occultist quickly by following these suggestions. First, Wisdom should be your highest ability score, followed by Constitution or Dexterity. Second, choose the [hermit](/3-Content/Compendiums/backgrounds/hermit.md) background. Third, choose the [poison spray](/3-Content/Compendiums/spells/poison-spray-xphb.md) and [produce flame](/3-Content/Compendiums/spells/produce-flame-xphb.md) cantrips, along with the 1st-level spells [burning hands](/3-Content/Compendiums/spells/burning-hands-xphb.md), cause fear, [cure wounds](/3-Content/Compendiums/spells/cure-wounds-xphb.md), and [tasha's hideous laughter](/3-Content/Compendiums/spells/tashas-hideous-laughter-xphb.md).

## Class Features

### Spellcasting (Level 1)

As a practioner of occult magic, you have inherited and developed techniques to manipulate reality through mediums of rituals, spirits, elements, and more. See "Spells Rules" for the general rules of spellcasting and the Spells Listing for the Occultist spell list.
...
For example, if you know the 1st-level spell [witchbolt](/3-Content/Compendiums/spells/witch-bolt-xphb.md) and have a 1st-level and a 2nd-level spell slot available, you can cast witchbolt using either slot.
...
Wisdom is your spellcasting ability for your Occultist spells. Your magic comes from a practitioners knowledge of traditional, ritual, and the way things work learned through experience, care and cunning. You use your Wisdom whenever a spell refers to your spellcasting ability. In addition, you use your Wisdom modifier when setting the saving throw DC for a Occultist spell you cast and when making an attack roll with one.
...
> [!note] Occult Fetish
> 
> Similar to a [Holy Symbol](/3-Content/Compendiums/items/holy-symbol-xphb.md) or an [Arcane Focus](/3-Content/Compendiums/items/arcane-focus-xphb.md), an Occult Fetish is a magical focus, but one that functions for the Occultist.
> 
> It can be almost anything, though usually has a somewhat macabre bent, such as a skull decorated with feathers or pendant decorated with teeth and runes.
> 
> You can buy or make one for 10 gp, and it typically weighs about 1 lb.
^occult-fetish

> [!note] Homebrew
> There are many inconsistencies between the spell list in the occultist class, the occultist spell list in Kibble's Casting Compendium, and the tags on spells printed in either source document. Of note is the 'Sudden Hazards' spell, which appears in the class spell list, but is not printed in either brew. For simplicity's sake, if it says it's an occultist spell somewhere in an up-to-date source, it's tagged as an occultist spell in this brew.

### Occult Tradition (Level 1)

Choose an occult tradition, shaping your the techniques, features, and rites available to you from the following: Oracle, Shaman, or Witch.
...
At 2nd Level, you gain two [Occult Rites](/3-Content/Compendiums/lists/list-optfeaturetype-ktor.md) of your choice. Your Occult Rites options are detailed at the end of the subclass description for subclass specific Rites, and at the end of the class description for general Rites, you can select from either you subclass or class list. When you gain certain Occultist levels, you gain additional Occult Rites of your choice.
...
Starting at 10th level, your passed down knowledge of tradition gives you expertise in a skill of your tradition; choose one of your skill proficiencies from [Animal Handling](/3-Content/Rules/skills.md#Animal%20Handling), [Arcana](/3-Content/Rules/skills.md#Arcana), [Medicine](/3-Content/Rules/skills.md#Medicine), [Nature](/3-Content/Rules/skills.md#Nature), [Survival](/3-Content/Rules/skills.md#Survival). Your Proficiency Bonus is doubled for any ability check you make that use of the chosen Proficiency. If you have proficiency in none of the selected skills, you can instead gain proficiency in one of your choice.
...
> ![Occult Rite](/3-Content/Compendiums/lists/list-optfeaturetype-ktor.md#Occult%20Rite)
^list-optfeature-ktor