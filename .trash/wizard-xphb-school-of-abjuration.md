...
> <tr class="class-progression"><td class"level">3rd</td><td class"pb">+2</td><td class"feature"><a href='#School of Abjuration (Level 3)' class='internal-link'>School of Abjuration</a></td></tr>
...
Beginning at 10th level, when you cast an abjuration spell that requires you to make an ability check as a part of casting that spell (as in [counterspell](/3-Content/Compendiums/spells/counterspell-xphb.md) and [dispel magic](/3-Content/Compendiums/spells/dispel-magic-xphb.md)), you add your proficiency bonus to that ability check.
