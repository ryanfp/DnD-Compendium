...
*Downtime is generally defined as a period of time when the players are not actively doing something that is pushing the main story forward, and is meant to serve as a sense of progression while time passes. A **Downtime Slot** is defined as a period of 6 hours that is able to be dedicated to a specific activity or venture called a **Downtime Activity**.*

Downtime activities represent specific and intentional activities that a character undertakes to achieve a benefit. A character can undertake one downtime activity per downtime slot.

A downtime period consists of 6 hours, and at the end of each downtime period, any required check is made and success or failure is determined. Some downtime activities may require multiple instances of downtime slots to complete. 

**Extended Downtime**. When a party of adventurers is experiencing a particularly long period of downtime, such as a year or longer, the GM may extend the length of the downtime period to 1 week and allow players to roll one check per 1 week of downtime activity. A success on an extended downtime check is treated as 5 successful slots of a downtime activity, a failure is treated as 2 successful slots, and on a failure by 5 or more the character makes no progress at the downtime activity.

For even longer periods of downtime, the GM can extend the downtime to seasons (treating a success as 12 weeks, a failure as 6 weeks, and a failure by 5 or more as 3 weeks), or even years (treating a success as 52 weeks, a failure as 26 weeks, and a failure by 5 or more as 13 weeks).
...
|---|:---:|:---:|:---:|:---:|---|---|
|Poor|½|10|⅛|-|Half|Gains the Broken condition after each use|
